...
// for db // import { addToDb, getStoreCart } from '../../utilities/fakedb';
...
const Home = () => {
    ...
    /* // for db
        //start for store local storage excercise detials
        useEffect(() => {
        ...
        // end for store local storage excercise detials
    */

    const addToCart = (team) => {
        const newCart = [...cart, team];
        setCart(newCart);
        // addToDb(team.id); // for db
    }
